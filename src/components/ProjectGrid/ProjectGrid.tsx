...
const ProjectGrid: React.FC<ProjectGridProps> = ({ activeFilter }): React.JSX.Element => {
  const projects = [
    ...
    {
      id: 2,
      title: 'Natures-Basket - Organic Vegetables Mart',
      description: 'Full-stack web application for buying and selling organic vegetables. Includes customer shopping, farmer product submissions (with admin approval), and admin management dashboard.',
      image: '/api/placeholder/400/300',
      category: 'fullstack',
      technologies: ['React.js', 'JavaScript', 'MongoDB', 'Express.js', 'Node.js', 'JWT', 'TailwindCSS'],
      liveUrl: 'https://naturesbasketapp.netlify.app/',
      githubUrl: 'https://github.com/shreyashkale9/Natures-Basket',
      featured: true
    },
    {
      id: 3,
    ...
    },
    {
      ...
      liveUrl: 'https://hotel-booking-app-gules.vercel.app/',
      githubUrl: 'https://github.com/shreyashkale9/Hotel-Booking_App',
      featured: false
    },
    {
      id: 5,
